    ...
    {currentVideogames ? (
      <div>
        ...
        <div className='opciones'>
          <Link to='/createvideogame' className='vinculo'>
            Crear Videojuego
          </Link>
          <Link to='/list' className='vinculo'>
            Mis Favoritos
          </Link>
          <Link to='/misjuegos' className='vinculo'>
            Mis Videojuegos
          </Link>
        </div>
        ...
        <div className='filtros'>
          <label className='encabezado'>Orden Alfabético: </label>
          ...
          <select className='seleccion' onChange={(e) => handleSortRank(e)}>
            <option value='men'>Menor Puntación</option>
            <option value='may'>Mayor Puntuación</option>
          </select>
          <label className='encabezado'> Por Géneros: </label>
          ...
          >
            ...
            <option value='created' disabled={validar}>
              Creados
            </option>
...
maximo={maximo}
    />*/}
        ...
        {currentVideogames.length > 0 ? (
                      ...
                      <Card
                        ...
                        image={
                          c.image
                            ? c.image
                            : (c.image =
                                "https://previews.123rf.com/images/urfandadashov/urfandadashov1809/urfandadashov180901275/109135379-foto-no-disponible-icono-del-vector-aislado-en-la-ilustraci%C3%B3n-transparente-transparente-concepto-de-.jpg")
                        }
                        rating={c.rating}
                        genres={c.genres}
                      />
          ...
          <div className='mario'>
            <img
              src={"https://giffiles.alphacoders.com/737/7376.gif"}
              alt={"Not Found"}
            />
          </div>
        )}
